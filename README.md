...
```bash
git clone https://github.com/lovepixel-git/skill-forge.git
cd skill-forge
bash install.sh
```
...
- **Issues**: [GitHub Issues](https://github.com/lovepixel-git/skill-forge/issues)
- **Discussions**: [GitHub Discussions](https://github.com/lovepixel-git/skill-forge/discussions)
